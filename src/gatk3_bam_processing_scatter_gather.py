...
def main(bam_files, sampleId, padding, reference, loglevel, number_of_nodes, downsample, downsample_fraction, regions_file=None, indel_vcf=None, dbsnp=None, advanced_rtc_options=None, advanced_ir_options=None, advanced_br_options=None, advanced_pr_options=None):
    ...
    if regions_file is not None:
        regions_file = dxpy.DXFile(regions_file)
    ...
    if regions_file is not None:
        dxpy.download_dxfile(regions_file.get_id(), "regions_file")
    ...
    output = {}
    output["output_recalibrated_bam"] = [dxpy.dxlink(item) for item in output_recalibrated_bam]
    output["output_recalibrated_cram"] = [dxpy.dxlink(item) for item in output_recalibrated_cram]
